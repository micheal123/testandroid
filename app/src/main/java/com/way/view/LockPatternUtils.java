...
public class LockPatternUtils {
	 ...
	 */
	public static final int MIN_LOCK_PATTERN_SIZE =3;//最小长度
	/**
	 * The maximum number of incorrect attempts before the user is prevented
	 * from trying again for {@link #FAILED_ATTEMPT_TIMEOUT_MS}.
	 */
	public static final int FAILED_ATTEMPTS_BEFORE_TIMEOUT = 4;//输入几次错误的最大
	/**
	 ...
	 */
	public static final long FAILED_ATTEMPT_TIMEOUT_MS = 60000L;//等待时间
